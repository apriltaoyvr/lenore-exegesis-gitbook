...
Compare the attitude toward reference points described in [No fixed reference points](./#no-fixed-reference-points).
...
_This last paragraph is actually true, but you have the INJ and INP stances mixed up. INJs, by dint of inferior_ [_sensation_](sensation/)_, and tertiary_ [_introverted judgement_](../judgement/)_, point to "sensory objects" with an evolving understanding of a realm of understanding. -_ [_Robert Evans_](https://web.archive.org/web/20081027221523/http://greenlightwiki.com/lenore-exegesis/Robert_Evans)
