...
**Introverted Feeling** (Fi) is a framework of [Subjective](../../../our-difficulties/terms-with-nonobvious-meanings/#objective-and-subjective) observations and values on the human experience. If [Introverted Thinking](../thinking/introverted-thinking-ti.md#definition-2-orientation-by-the-groove) can be defined as a culmination of logical 'grooves', Introverted Feeling is a culmination of emotional grooves.&#x20;

What is a groove? It is an intuitive (in the layman sense) understanding of the 'laws' that govern us. For example, we understand the basic laws of gravity as children before we can learn its scientific principles. Yet it is difficult to remember the first moment in which we discovered this lesson. The result of it is ingrained in our guts and unconsciously applied to all our physical actions but we cannot to the exact principles themselves without study. It is a gestalt of past experiences and lessons.

In the context of Fi, a groove is then a gestalt and culmination of lessons on ethics, social dynamics, and other things within the realm of [Feeling](./). It is often anchored in the Fi user's experiences due to the [Subjective](../../../our-difficulties/terms-with-nonobvious-meanings/#objective-and-subjective) nature of Fi.

There is a belief that in understanding of the self and others, one can understand the human experience more deeply and to be able to see both the uniqueness and common threads between people. Therefore, there is a natural dislike for painting others with broad strokes or judging social and emotional situations too quickly: an important lesson can be learned, a misinterpretation can be created, and an opportunity to refine the Fi framework can be lost.&#x20;

For example: Understanding that difficult situations can create anger via experiencing this same anger in themselves under duress _and_ understanding that this same anger can hurt others by being the victim of another person's anger. Experiencing these two situations as the subject allows for Fi to deeply understand the _feelings_ and motivations involved and to sympathize with both positions.&#x20;

An Fi user with this background can understand then that it is difficult to know when it is 'right' or 'wrong' to be angry, to have stronger empathy for 'uglier' emotions and perspectives, because the Fi user knows it is derived from deprivation and a sense of injustice. But to also acknowledge the pain and sorrow of the recipient because it is difficult to receive another person's anger. There is an understanding that perhaps in the same circumstances many others would do the same and wish for grace and empathy. They often have an inclination to feel sympathy for the devil while acknowledging his wrongs.&#x20;

Introverted Feeling is continuously refining the framework by examining the self and others. When Fi is underdeveloped, it is often stubborn and narrow-minded--unable to understand and accept values too different than theirs. When it is more fully realised, it can understand various perspectives, lives, emotions, and values profoundly because it acknowledges the depth of others' frameworks to be as valid as theirs: "What is right for me may not be right for you; we are operating from different values, beliefs and needs."&#x20;
